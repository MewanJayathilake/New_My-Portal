...
<?php
// get countries and languages from helper
                      ...
                      <div class="control">
                        <div class="select">
                           <select name="IndigenousStatusID" id="IndigenousStatusID">
                            <!-- select Aboriginal or Torres Strait Islander  -->
                                            <option value="">Please select</option>
                                 <option value="">Please select</option>
                                            <option value="1">Yes, Aboriginal</option>
                                            <option value="2">Yes, Torres Strait Islander</option>
                                            <option value="4">No</option>
                                            <option value="@">I would prefer not to disclose this information
                                </option>      
                            </select>
                        </div>
                      </div>
